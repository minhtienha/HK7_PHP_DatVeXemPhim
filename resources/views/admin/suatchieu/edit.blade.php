                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="trang_thai" class="form-select" required>
                            <option value="sap_chieu" {{ old('trang_thai', $suatChieu->trang_thai) == 'sap_chieu' ? 'selected' : '' }}>Sắp chiếu</option>
                            <option value="dang_chieu" {{ old('trang_thai', $suatChieu->trang_thai) == 'dang_chieu' ? 'selected' : '' }}>Đang chiếu</option>
                            <option value="da_ket_thuc" {{ old('trang_thai', $suatChieu->trang_thai) == 'da_ket_thuc' ? 'selected' : '' }}>Đã kết thúc</option>
                        </select>
                    </div>
                </div>
